import { SAMPLE_RATE,TIMELINE_LENGTH,MIPMAP_RESOLUTIONS, MIPMAP_HALF_SIZE } from "@/Constants/constants";
...
export function renderMixWaveforms(ref: React.RefObject<HTMLElement>, data: StateContainer, mipMap: Int8Array){
        ...
        const pxPerSecond = SAMPLE_RATE / data.viewport.samplesPerPx;
