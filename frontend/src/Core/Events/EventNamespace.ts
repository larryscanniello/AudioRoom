...
export type EventParams = {
    [EventTypes.START_PLAYBACK]: number;
    ...
    [EventTypes.BOUNCE]: {timeline: TimelineState, bounce: number, mixerState: MixerState},
    ...
    [EventTypes.OTHER_PERSON_RECORDING]: {take:number, globalTake:number, playheadTimeSeconds: number},
    ...
    [EventTypes.DELETE_MIX_BOUNCES]: {timeline: TimelineState, mixerState: MixerState},
    [EventTypes.RESTAGE]: {timeline: TimelineState, mixerState: MixerState},
